...
import org.keycloak.protocol.saml.rotation.SAMLIDPDecryptionKeysLocator;
                ...
                if (assertionIsEncrypted) {
                    try {
                        ...
                        /* End of deprecated code */
                            assertionElement = AssertionUtil.decryptAssertion(responseType, new SAMLIDPDecryptionKeysLocator(session, realm, config));
                        }
                ...
                if (AssertionUtil.isIdEncrypted(responseType)) {
                    try {
                        ...
                        if (DEPRECATED_ENCRYPTION) {
                            ...
                            /* End of deprecated code */
                            AssertionUtil.decryptId(responseType, new SAMLIDPDecryptionKeysLocator(session, realm, config));
                        }
                    } catch (ProcessingException ex) {
                        throw new WebApplicationException(ex, Response.Status.BAD_REQUEST);
                    }
