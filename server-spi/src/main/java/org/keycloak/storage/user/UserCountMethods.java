...
public interface UserCountMethods {
    /**
    ...
    default int getUsersCount(RealmModel realm, Set<String> groupIds) {
        if (groupIds == null || groupIds.isEmpty() || !(this instanceof UserQueryMethods)) {
            return 0;
        }
        return countUsersInGroups(((UserQueryMethods)this).searchForUserStream(realm, Collections.emptyMap()), groupIds);
    }
    ...
    default int getUsersCount(RealmModel realm, String search) {
        if (!(this instanceof UserQueryMethods)) {
            return 0;
        }

        return (int) ((UserQueryMethods)this).searchForUserStream(realm, search).count();
    }
    ...
    default int getUsersCount(RealmModel realm, String search, Set<String> groupIds) {
        ...
        return countUsersInGroups(((UserQueryMethods)this).searchForUserStream(realm, search), groupIds);
    }
    ...
    default int getUsersCount(RealmModel realm, Map<String, String> params) {
        ...
        return (int) ((UserQueryMethods)this).searchForUserStream(realm, params).count();
    }
    ...
    default int getUsersCount(RealmModel realm, Map<String, String> params, Set<String> groupIds) {
        ...
        return countUsersInGroups(((UserQueryMethods)this).searchForUserStream(realm, params), groupIds);
    }
