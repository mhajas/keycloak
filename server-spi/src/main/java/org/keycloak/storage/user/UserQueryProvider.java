...
public interface UserQueryProvider {
     ...
     */
    @Deprecated
    List<UserModel> searchForUser(String search, RealmModel realm, Integer firstResult, Integer maxResults);
     ...
     */
    @Deprecated
    List<UserModel> searchForUser(Map<String, String> params, RealmModel realm, Integer firstResult, Integer maxResults);
     ...
     */
    @Deprecated
    List<UserModel> getGroupMembers(RealmModel realm, GroupModel group, Integer firstResult, Integer maxResults);
     ...
     */
    @Deprecated
    default List<UserModel> getRoleMembers(RealmModel realm, RoleModel role, Integer firstResult, Integer maxResults) {
    ...
    interface Streams extends UserQueryProvider {
        ...
        @Override
        default List<UserModel> searchForUser(String search, RealmModel realm, Integer firstResult, Integer maxResults) {
        ...
        @Override
        default List<UserModel> searchForUser(Map<String, String> params, RealmModel realm, Integer firstResult, Integer maxResults) {
        ...
        @Override
        default List<UserModel> getGroupMembers(RealmModel realm, GroupModel group, Integer firstResult, Integer maxResults) {
