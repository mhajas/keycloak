...
public class KeyUtils {
    ...
    public static KeysMetadataRepresentation.KeyMetadataRepresentation getActiveSigningKey(KeysMetadataRepresentation keys, String algorithm) {
        for (KeysMetadataRepresentation.KeyMetadataRepresentation k : keys.getKeys()) {
            if (k.getAlgorithm().equals(algorithm) && KeyStatus.valueOf(k.getStatus()).isActive() && (k.getUse() == null || KeyUse.SIG.equals(k.getUse()))) {
                return k;
            }
        }
    ...
    public static KeysMetadataRepresentation.KeyMetadataRepresentation getActiveEncKey(KeysMetadataRepresentation keys, String algorithm) {
        for (KeysMetadataRepresentation.KeyMetadataRepresentation k : keys.getKeys()) {
            if (k.getAlgorithm().equals(algorithm) && KeyStatus.valueOf(k.getStatus()).isActive() && (k.getUse() == null || KeyUse.ENC.equals(k.getUse()))) {
                return k;
            }
        }
        throw new RuntimeException("Active key not found");
    ...
    public static KeysMetadataRepresentation.KeyMetadataRepresentation getActiveSigningKeyOfType(KeysMetadataRepresentation keys, String type) {
        for (KeysMetadataRepresentation.KeyMetadataRepresentation k : keys.getKeys()) {
            if (k.getType().equals(type) && KeyStatus.valueOf(k.getStatus()).isActive() && (k.getUse() == null || KeyUse.SIG.equals(k.getUse()))) {
                return k;
            }
        }
        throw new RuntimeException("Active key not found");
    ...
    public static KeysMetadataRepresentation.KeyMetadataRepresentation getActiveEncKeyOfType(KeysMetadataRepresentation keys, String type) {
        for (KeysMetadataRepresentation.KeyMetadataRepresentation k : keys.getKeys()) {
            if (k.getType().equals(type) && KeyStatus.valueOf(k.getStatus()).isActive() && (k.getUse() == null || KeyUse.ENC.equals(k.getUse()))) {
                return k;
            }
        }
        throw new RuntimeException("Active key not found");
