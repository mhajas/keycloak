...
public class KeycloakServerDeploymentProcessor implements DeploymentUnitProcessor {
    ...
    private static final String[] CACHES = new String[] {
        "realms", "users","sessions","authenticationSessions","offlineSessions","clientSessions","offlineClientSessions","loginFailures", "artifacts","work","authorization","keys","actionTokens"
    };
