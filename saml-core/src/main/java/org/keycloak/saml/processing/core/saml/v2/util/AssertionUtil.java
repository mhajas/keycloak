...
public class AssertionUtil {
     ...
     */
    public static Element decryptAssertion(ResponseType responseType, DecryptionKeyLocator decryptionKeyLocator) throws ParsingException, ProcessingException, ConfigurationException {
     ...
     *
     */
    public static void decryptId(final ResponseType responseType, DecryptionKeyLocator decryptionKeyLocator) throws ConfigurationException, ProcessingException, ParsingException {
        final STSubType subTypeElement = getSubTypeElement(responseType);
