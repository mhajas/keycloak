...
public interface ResourceStore {
    ...
    default Resource findByName(ResourceServer resourceServer, String name) {
        return findByName(resourceServer.getId(), name, resourceServer.getClientId());
    }
    ...
    default List<Resource> findByTypeInstance(String type, ResourceServer resourceServer) {
        List<Resource> list = new LinkedList<>();
