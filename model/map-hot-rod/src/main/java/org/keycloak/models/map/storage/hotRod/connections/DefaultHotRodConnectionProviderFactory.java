...
public class DefaultHotRodConnectionProviderFactory implements HotRodConnectionProviderFactory {
    ...
    public void lazyInit() {
        ...
        // configure near caching
        ENTITY_DESCRIPTOR_MAP.values().stream().map(HotRodEntityDescriptor::getCacheName)
                .forEach(name -> remoteBuilder.remoteCache(name)
                        ...
                        .nearCacheMaxEntries(config.scope(name).getInt("nearCacheMaxEntries", config.getInt("nearCacheMaxEntries", 10000)))
