...
public class InfinispanUserLoginFailureProviderFactory implements UserLoginFailureProviderFactory {
    ...
    public UserLoginFailureProvider create(KeycloakSession session) {
        ...
        return new InfinispanUserLoginFailureProvider(session, loginFailures, new InfinispanChangelogBasedTransaction<>(session, loginFailures, SessionTimeouts::getLoginFailuresLifespanMs, SessionTimeouts::getLoginFailuresMaxIdleMs));
    }
