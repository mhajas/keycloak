...
public class PermissionTicketAdapter implements PermissionTicket, CachedModel<PermissionTicket> {
    ...
    public PermissionTicket getDelegateForUpdate() {
        if (updated == null) {
            ResourceServer resourceServer = cacheSession.getResourceServerStoreDelegate().findById(PermissionTicketStore.NULL_REALM, cached.getResourceServerId());
            updated = cacheSession.getPermissionTicketStoreDelegate().findById(PermissionTicketStore.NULL_REALM, resourceServer, cached.getId());
    ...
    public Policy getPolicy() {
        ...
        return cacheSession.getPolicyStore().findById(PermissionTicketStore.NULL_REALM, cacheSession.getResourceServerStore().findById(PermissionTicketStore.NULL_REALM, cached.getResourceServerId()), cached.getPolicy());
    }
    ...
    public Resource getResource() {
        return cacheSession.getResourceStore().findById(PermissionTicketStore.NULL_REALM, getResourceServer(), cached.getResourceId());
    }

    @Override
    public Scope getScope() {
        return cacheSession.getScopeStore().findById(PermissionTicketStore.NULL_REALM, getResourceServer(), cached.getScopeId());
    }
