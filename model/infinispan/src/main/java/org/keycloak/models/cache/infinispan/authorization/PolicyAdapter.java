...
public class PolicyAdapter implements Policy, CachedModel<Policy> {
    ...
    protected boolean isUpdated() {
        ...
        updated = cacheSession.getPolicyStoreDelegate().findById(PermissionTicketStore.NULL_REALM, cacheSession.getResourceServerStore().findById(PermissionTicketStore.NULL_REALM, cached.getResourceServerId()), cached.getId());
        if (updated == null) throw new IllegalStateException("Not found in database");
        return true;
    }
    ...
    public ResourceServer getResourceServer() {
        return cacheSession.getResourceServerStore().findById(PermissionTicketStore.NULL_REALM, cached.getResourceServerId());
    }
    ...
    public Set<Policy> getAssociatedPolicies() {
        ...
        for (String id : cached.getAssociatedPoliciesIds(modelSupplier)) {
            Policy policy = policyStore.findById(PermissionTicketStore.NULL_REALM, cacheSession.getResourceServerStore().findById(PermissionTicketStore.NULL_REALM, resourceServerId), id);
    ...
    public Set<Resource> getResources() {
        ...
        for (String resourceId : cached.getResourcesIds(modelSupplier)) {
            Resource resource = resourceStore.findById(PermissionTicketStore.NULL_REALM, resourceServer, resourceId);
    ...
    public Set<Scope> getScopes() {
        ...
        for (String scopeId : cached.getScopesIds(modelSupplier)) {
            Scope scope = scopeStore.findById(PermissionTicketStore.NULL_REALM, resourceServer, scopeId);
    ...
    private Policy getPolicyModel() {
        return cacheSession.getPolicyStoreDelegate().findById(PermissionTicketStore.NULL_REALM, cacheSession.getResourceServerStore().findById(PermissionTicketStore.NULL_REALM, cached.getResourceServerId()), cached.getId());
    }
}
