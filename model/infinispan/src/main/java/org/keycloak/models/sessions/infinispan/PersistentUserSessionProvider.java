...
public class PersistentUserSessionProvider implements UserSessionProvider, SessionRefreshStore {
    ...
    public PersistentUserSessionProvider(KeycloakSession session,
        ...
        this.sessionTx = new UserSessionPersistentChangelogBasedTransaction(session,
                ...
                serializerSession, serializerOfflineSession,
        ...
        this.clientSessionTx = new ClientSessionPersistentChangelogBasedTransaction(session,
                ...
                sessionTx,
                serializerClientSession, serializerOfflineClientSession,
...
//                ClusterProvider.DCNotify.LOCAL_DC_ONLY);
    ...
    public void processDeferredUserSessionElements(Collection<PersistentDeferredElement<String, UserSessionEntity>> batch) {
        sessionTx.applyDeferredBatch(batch);
    }

    public void processDeferredClientSessionElements(Collection<PersistentDeferredElement<UUID, AuthenticatedClientSessionEntity>> batch) {
        clientSessionTx.applyDeferredBatch(batch);
    }
