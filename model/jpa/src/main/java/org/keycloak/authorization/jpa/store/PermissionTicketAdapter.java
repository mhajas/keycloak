...
public class PermissionTicketAdapter implements PermissionTicket, JpaModel<PermissionTicketEntity> {
    ...
    public ResourceServer getResourceServer() {
        return storeFactory.getResourceServerStore().findById(PermissionTicketStore.NULL_REALM, entity.getResourceServer().getId());
    }
    ...
    public Policy getPolicy() {
        ...
        ResourceServer resourceServer = storeFactory.getResourceServerStore().findById(PermissionTicketStore.NULL_REALM, entity.getResourceServer().getId());
        return storeFactory.getPolicyStore().findById(PermissionTicketStore.NULL_REALM, resourceServer, policy.getId());
    }
    ...
    public Resource getResource() {
        return storeFactory.getResourceStore().findById(PermissionTicketStore.NULL_REALM, getResourceServer(), entity.getResource().getId());
    }
    ...
    public Scope getScope() {
        ...
        return storeFactory.getScopeStore().findById(PermissionTicketStore.NULL_REALM, getResourceServer(), scope.getId());
    }
