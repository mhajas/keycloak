...
public class JPAScopeStore implements ScopeStore {
    ...
    public Scope findByName(ResourceServer resourceServer, String name) {
        try {
            ...
            return provider.getStoreFactory().getScopeStore().findById(PermissionTicketStore.NULL_REALM, resourceServer, id);
    ...
    public List<Scope> findByResourceServer(final ResourceServer resourceServer) {
        ...
        for (String id : result) {
            list.add(provider.getStoreFactory().getScopeStore().findById(PermissionTicketStore.NULL_REALM, resourceServer, id));
        }
        return list;
    }
    ...
    public List<Scope> findByResourceServer(ResourceServer resourceServer, Map<Scope.FilterOption, String[]> attributes, Integer firstResult, Integer maxResults) {
        ...
        for (Object id : result) {
            list.add(provider.getStoreFactory().getScopeStore().findById(PermissionTicketStore.NULL_REALM, resourceServer, (String)id));
        }
        return list;
