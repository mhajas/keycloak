...
public class ResourceAdapter extends AbstractAuthorizationModel implements Resource, JpaModel<ResourceEntity> {
    ...
    public List<Scope> getScopes() {
        ...
        for (ScopeEntity scope : entity.getScopes()) {
            scopes.add(storeFactory.getScopeStore().findById(PermissionTicketStore.NULL_REALM, resourceServer, scope.getId()));
        }
    ...
    public ResourceServer getResourceServer() {
        return storeFactory.getResourceServerStore().findById(PermissionTicketStore.NULL_REALM, entity.getResourceServer());
    }
